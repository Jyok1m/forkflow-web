...
export type RestaurantsQuery = { restaurants: Array<{ publicId: string, name: string, bannerUrl: string, line1: string, line2: string | null, city: string, postCode: string, country: string, style: string, serviceSlots: Array<{ date: string }> }> };
